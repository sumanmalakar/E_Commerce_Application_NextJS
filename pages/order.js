        ...
        <div class="container px-5 py-24 mx-auto">
          <div class="lg:w-4/5 mx-auto flex flex-wrap">
            <div class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
              <h2 class="text-sm title-font text-gray-500 tracking-widest">E-Commerce Store</h2>
              <h1 class="text-gray-900 text-3xl title-font font-medium mb-4">Order Id: #894820</h1>
